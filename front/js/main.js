...
let sM1 = document.querySelector('.scroll-menu-1');
let sM2 = document.querySelector('.scroll-menu-2');
let sM3 = document.querySelector('.scroll-menu-3');
let sM4 = document.querySelector('.scroll-menu-4');
let sM5 = document.querySelector('.scroll-menu-5');

let sMN2 = document.querySelector('.scroll-menu-neg2');
let sMN1 = document.querySelector('.scroll-menu-neg1');
